...
//    _reuseIdentifier = reuseIdentifier;
    ...
    if (self) {
        ...
        if([reuseIdentifier isEqualToString:@"FixedCost"])
        {
            //label
            costLabel = [[UILabel alloc]init];
            costLabel.frame = CGRectMake(20.0f, 0.0f, 160.0f, 44.0f);
            costLabel.backgroundColor = [UIColor clearColor];
            costLabel.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleHeight;
            ...
            rightBorder.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleHeight;
        ...
        else if([reuseIdentifier isEqualToString:@"TableViewList"])
        {
            //label
            costLabel = [[UILabel alloc]init];
            costLabel.frame = CGRectMake(20.0f, 0.0f, 160.0f, 44.0f);
...
-(void) updateState: (MGSwipeState) newState;
{
    ...
    if (_swipeOverlay.hidden) {
        costLabel.hidden = NO;
        imageView.hidden = NO;
        rightBorder.hidden = NO;
        textField.hidden = NO;
        textNewLabel.hidden = NO;
    }
