...
#import "ProductPost2ViewController.h"
...
@interface ProductPost2ViewController ()<UISearchBarDelegate,UISearchControllerDelegate>
{
...
@implementation ProductPost2ViewController
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow: (NSInteger)row inComponent:(NSInteger)component {
    ...
    [_homeModel downloadItems:dbPostDetailToPost condition:@[_strSelectedEventID,strPage]];
...
{
//    _isUnwind = YES;
    if([[segue sourceViewController] isMemberOfClass:[PreOrderScanPost2ViewController class]])
    {
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        PreOrderScanPost2ViewController *vc = segue.destinationViewController;
