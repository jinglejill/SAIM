...
#import "PreOrderPage2ViewController.h"
...
@interface PreOrderPage2ViewController ()
{
    HomeModel *homeModel;
...
@implementation PreOrderPage2ViewController
- (void)loadView
{
    [super loadView];
...
- (PreOrder2ViewController *)viewControllerAtIndex:(NSUInteger)index {
    ...
    PreOrder2ViewController * initialViewController = [storyboard instantiateViewControllerWithIdentifier:@"PreOrder2ViewController"];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    ...
    NSUInteger index = [(PreOrder2ViewController *)viewController index];
