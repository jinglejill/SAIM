//
//  ReportTopSpenderDetailViewController.m
//  SAIM
//
...
@interface ReportTopSpenderDetailViewController ()
{
...
@implementation ReportTopSpenderDetailViewController
@synthesize txtStartDate;
@synthesize txtEndDate;
@synthesize segConPeriod;
@synthesize selectedTopSpender;
@synthesize tbvData;
...
- (void)viewDidLoad
{
    ...
    [self.homeModel downloadItems:dbReportTopSpenderDetail condition:@[txtStartDate.text,txtEndDate.text,strOption,selectedTopSpender.telephone]];    
}
...
-(void)itemsDownloaded:(NSArray *)items
{
    ...
    if(self.homeModel.propCurrentDB == dbReportTopSpenderDetail)
    {
        int i=0;
