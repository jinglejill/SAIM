//
//  PreOrderAddPreOrderPageViewController.m
//  SAIM_UPDATING
//
...
#import "PreOrderAddPreOrderPageViewController.h"
...
@interface PreOrderAddPreOrderPageViewController ()
{
...
@implementation PreOrderAddPreOrderPageViewController
- (void)loadView
{
    [super loadView];
...
- (PreOrderAddPreOrderViewController *)viewControllerAtIndex:(NSUInteger)index {
    
    
    NSString * storyboardName = @"Main";
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:storyboardName bundle: nil];
    PreOrderAddPreOrderViewController * initialViewController = [storyboard instantiateViewControllerWithIdentifier:@"PreOrderAddPreOrderViewController"];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    ...
    NSUInteger index = [(PreOrderAddPreOrderViewController *)viewController index];
