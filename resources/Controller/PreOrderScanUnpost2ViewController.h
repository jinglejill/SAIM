//
//  PreOrderScanUnpost2ViewController.h
//  SAIM
//
...
@interface PreOrderScanUnpost2ViewController : UIViewController<HomeModelProtocol, AVCaptureMetadataOutputObjectsDelegate>
