...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell.imageView isDescendantOfView:cell])
    {
        ...
        for(ProductWithQuantity *item in _productWithQuantity)
        {
            ...
            if([item.productName isEqualToString:_sortedProductName[indexPath.section]] && [item.color isEqualToString:sortedColor[(indexPath.item/(sizeNum+1))-1]] && [item.size isEqualToString:productSize.code])
            {
